      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1">
          <h1 className="text-5xl md:text-7xl font-display leading-[1.1] mb-6 animate-fade-in">
            Reconcilie-se com sua história e encontre o equilíbrio para o seu <span className="italic text-primary">presente.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              href="#"
            >
              Começar <span className="material-icons-outlined">arrow_forward</span>
            </a>
            <a
